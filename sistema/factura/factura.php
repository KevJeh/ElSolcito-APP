...
<div id="page_pdf">
		...
		<tr>
			...
			<td class="info_empresa">
				...
				<div>
					...
					<p>CUIT/CUIL: <?php echo $configuracion['cuit']; ?></p>
			...
			<td class="info_factura">
				<div class="round">
					...
					<p>Nro. Comprobante: <strong><?php echo $factura['nofactura']; ?></strong></p>
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							<td><label>CUIT/CUIL:</label><p><?php echo $factura['cuit']; ?></p></td>
	...
	<div>
		<p class="nota">El actual comprobante no posee valor fiscal.</p>
